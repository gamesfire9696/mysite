    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <div class="flex flex-col flex-1 w-full">
          ...
          <main class="h-full overflow-y-auto">
            ...
            <div class="grid gap-4 p-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
             ...
             <h1 class="text-3xl font-bold text-center text-red-700">لا توجد قنوات حاليا </h1>
              @endforelse
          </main>
        </div>
      </div>
