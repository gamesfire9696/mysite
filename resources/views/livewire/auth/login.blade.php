            ...
            <h1 class="mb-4 text-xl font-semibold text-gray-700 dark:text-gray-200">
              ...
              <form wire:submit.prevent="login">
                    ...
                    <span class="text-gray-700 dark:text-gray-400">Email</span>
                       <input wire:model="email" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="name@email.com">
                    </label>
                        @error('email')
                    ...
                    <span class="text-gray-700 dark:text-gray-400">Password</span>
                        <input wire:model.lazy="password" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="***************" type="password">
                    </label>
                        @error('password')
                        <span class="text-xs text-red-600 dark:text-red-400">
                        {{$message}}
