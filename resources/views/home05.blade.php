  ...
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
      ...
      <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
          <li class="relative px-6 py-3">
            ...
            <a class="inline-flex items-center w-full text-sm font-semibold  transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="{{route('page01')}}">
        ...
        <ul>
          <li class="relative px-6 py-3">
            ...
            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="{{route('page02')}}">
    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full overflow-y-auto">
        ...
        <div class="m-2 min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
          <h4 class="mb-4 font-semibold text-gray-600 dark:text-gray-300">
            Video
          </h4>
          <h1 class="mb-4 font-semibold text-blue-800 text-center text-xl">
            Bein Sport hd1
          </h1>
          <p class="mb-4 font-semibold text-gray-600 dark:text-gray-300 text-center text-lg">
            هو فيلم رائع تدور قصته حول فارس مغوار تم قتله
          </p>
          <iframe class="w-full aspect-video md:aspect-square" src="http://stariptv.org:8080/movie/hamza2022/123456/149925.mp4"></iframe>
